...
<head>
	...
	<!--[if IE 8]> <meta name="viewport" content="width=1200, maximum-scale=1.0, user-scalable=yes"> <![endif]-->
	<!--[if gt IE 8]><!-->
	<script>
		var screenWidth = screen.width,
				windowWidth = window.outerWidth,
				respMeta    = '<meta name="viewport" content="width=device-width, initial-scale=1.0"/>',
				noRespMeta  = '<meta name="viewport" content="width=1200, maximum-scale=1.0, user-scalable=yes">',
				deviceWidth = 1200
		;
